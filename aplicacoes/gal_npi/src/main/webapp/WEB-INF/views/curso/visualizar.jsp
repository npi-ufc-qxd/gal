				...
				<div id="${curriculo.id}" class="tab-pane ${active }">
					...
					<sec:authorize access="hasAnyRole('BIBLIOTECARIO', 'COORDENADOR_CURSO')">
						<div class="panel panel-default">
							<datatables:table id="estrutura${curso.id}" data="${curriculo.curriculos}" cdn="false" row="integracao" theme="bootstrap2" cssClass="table table-striped table-orderable" no-sort-fields="1 2 4" default-sort="3 desc">
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="text-align: center;">
						<form:form servletRelativeAction="/integracao/adicionar"
							...
							<div class="form-group">
								<label for="disciplinaInput2" class="col-sm-2 control-label">Código
									Disciplina</label>
								<div class="col-sm-10">
									<form:input id="disciplinaInput2" class="form-control"
									...
									<div class="modal-content">
										...
										<div class="modal-body" style="text-align: center;">
											<form:form servletRelativeAction="/integracao/adicionar"
												...
												<div class="form-group">
													<label for="disciplinaInput3"
														class="col-sm-2 control-label">Código Disciplina</label>
													<div class="col-sm-10">
														<form:input id="disciplinaInput3" class="form-control"
															style="width: 150px;" placeholder="Código disciplina"
															path="disciplina" required="true" />
														<form:errors path="disciplina" cssClass="error" />
													</div>
