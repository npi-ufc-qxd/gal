...
<body>
	<div id="container">
		...
		<form:form servletRelativeAction="/cotacao/adicionar" method="post" modelAttribute="cotacao" role="form" class="form-horizontal">
			
			<div class="form-group" style="text-align: center;">
				<label class="control-label" style="font-size: 20px;">Adicionar Cotação</label>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			    	...
			    	<form:select path="fornecedor.id" id="select-fornecedor" class="form-control">		 
			    		<form:option value="" selected="selected"> -- Selecione um fornecedor -- </form:option>   		
