...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	...
	<script src="<c:url value="/resources/js/libs/jquery.cookie.js" />"></script>
	...
	<script src="<c:url value="/resources/js/libs/dataTables.bootstrap.min.js" />"></script>
	...
	<script src="<c:url value="/resources/js/libs/select2_locale_pt-BR.js" />"></script>
<%-- 	<script src="<c:url value="/resources/js/common-scripts.js" />"></script> --%>
	<script src="<c:url value="/resources/js/libs/jquery.fastLiveFilter.js" />"></script>
	<script src="<c:url value="/webjars/datatables/1.10.11/js/jquery.dataTables.min.js" />"></script>
	<script src="<c:url value="/resources/js/libs/sortable.js" />"></script>
	<script src="<c:url value="/resources/js/libs/Sortable.js" />"></script> <!-- Nova biblioteca para manipulação de drag and drop -->
  ...
  <footer>
        ...
        <div class="container text-center">
            ...
            <p><a href="http://www.npi.quixada.ufc.br" target="_blank">Núcleo de Práticas em Informática</a></p>
