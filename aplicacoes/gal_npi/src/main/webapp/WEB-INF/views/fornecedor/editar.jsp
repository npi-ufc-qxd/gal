...
<body>
	<div id="container">
		...
		<form:form servletRelativeAction="/fornecedor/editar" method="post" modelAttribute="fornecedor" role="form" class="form-horizontal">
		<form:input path="id" type="hidden" />
				
			<div class="form-group" style="text-align: center;">
				<label class="control-label" style="font-size: 20px;">Editar Fornecedor</label>
			</div>
			...
			<div class="controls">
				...
				<a href="<c:url value="/fornecedor/listar"></c:url>" class="btn btn-default">Cancelar</a>
			</div>
		</form:form>
		</div>
		</div>
